...
class LLMMatcher:
    ...
    TOP_POPULAR_VV_IDS = [4324, 446, 8852, 10029, 10039, 10043]
    ...
    def __init__(self, project_root: Path | None = None):
        ...
        self.TOP_POPULAR_VV_IDS = [4324, 446, 8852, 10029, 10039, 10043]
    ...
    def _ensure_resources_loaded(cls):
        ...
        items_dict_path = project_root / "items_dict.json"
        with open(items_dict_path, "r", encoding="utf-8") as f:
            raw_items = json.load(f)
            cls._items_dict = {int(k): v.lower() for k, v in raw_items.items()}
            # ic(cls._items_dict)
        ...
        vv_catalog_path = project_root / "vv_catalog.json"
        ...
        # TODO import db
        shop_db_path = "D:/gleb/Recsys_projeccts/sirius_seminars/vkusvill_case/src/new_matcher/shop.db"
    ...
    def _map_llm_to_pov_ids(
        ...
        for query in llm_outputs:
            ...
            for _, row in results.iterrows():
                ...
                ic((pov_id, ingredient_name, [query]))
    ...
    def _rerank_candidates(
        ...
        for candidate in candidates:
            ...
            # Get EASE score
            ease_score = ease_scores.get(
                pov_id, 0.001
            )  # получаем скор или отдаем константу
